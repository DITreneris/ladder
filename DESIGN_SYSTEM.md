...
| `badge-rank-intern` / `-manager` / `-director` / `-ceo` | In-game rank pill |
...
| Director | `badge-rank-director` | ≥ 20 years (violet — v2.1) |
...
## 10. v1.9 / v2.0 UI addenda

Shell tokens unchanged from v1.8.5; new surfaces only:

| Surface | Element | Notes |
|---------|---------|-------|
| Home | `#avatarIconBtn` | Emoji avatar picker (localStorage) |
| Home | `#homeBrandFooter` | Official Prompt Anatomy logo asset |
| Game | Sprint HUD chip | Synergy Sprint wall-clock countdown |
| Game over | `#reviveAdBtn` | “Mandatory HR Training” — AdsGram rewarded revive |
...
**Declared:** Design System **v1.8.5 shell + v1.9/v2.0 addenda** (2026-06-08) — see [CHANGELOG 1.9.0](CHANGELOG.md#190---2026-06-14) and [ROADMAP § Shipped baseline](ROADMAP.md#shipped-baseline-v19--v20--unreleased).
