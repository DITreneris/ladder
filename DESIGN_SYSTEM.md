...
**Do not add** decorative marketing animations to shell screens beyond existing row-fade-in and ticker.
...
Shell buttons: `min-h-[44px]` via `btn-cl-*` utilities. **Exceptions (documented):** game tap halves (`h-28`), leaderboard tab pills (compact toggle).
